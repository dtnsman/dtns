...
const LX_OBJ_TOKEN_NAMESPACE_PRE_FIX="NFTlist_"
const LX_OBJ_TOKEN_NAMESPACE='obj'

window.lx_obj_config= {}
window.lx_obj_config.fsm_config = {
...
window.lx_obj_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LX_OBJ_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     */
    TOKEN_NAME:LX_OBJ_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LX_OBJ_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LX_OBJ_TOKEN_NAMESPACE_PRE_FIX,
    /**
     * token_ID的长度（一般16位左右就足够了）
     */
    TOKEN_ID_LENGTH:16,
    TOKEN_CLT_TIPS_STR:'xxxxxxx',//默认为此(用于截断token_id)
    /**
