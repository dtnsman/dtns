/**
 * Created by container:192.168.1.25:62000 on 2020-04-13 18:08
 */
// const str_filter = require('./libs/str_filter');
// const HOST_SPACE = str_filter.getIPAdress();
const LX_RMB_TOKEN_NAMESPACE_PRE_FIX="NFTlist_"
const LX_RMB_TOKEN_NAMESPACE='rmb'
window.lx_rmb_config = {}
window.lx_rmb_config.fsm_config = {
...
window.lx_rmb_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LX_RMB_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     */
    TOKEN_NAME:LX_RMB_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LX_RMB_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LX_RMB_TOKEN_NAMESPACE_PRE_FIX,
    /**
    ...
    DOMAIN_PORT:59874,//50992,
    /**
     * 域名
     * 这里会影响db与redis的访问
     *
     * DOMAIN_DTNS:'coin.pop.lang',
     */
    DOMAIN_DTNS:'coin.pop.lang',
    /**
