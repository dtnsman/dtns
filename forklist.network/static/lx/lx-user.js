...
const LX_USER_TOKEN_NAMESPACE_PRE_FIX="NFTlist_"
const LX_USER_TOKEN_NAMESPACE='user'

window.lx_user_config = {}
window.lx_user_config.fsm_config = {
...
window.lx_user_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LX_USER_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     */
    TOKEN_NAME:LX_USER_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LX_USER_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LX_USER_TOKEN_NAMESPACE_PRE_FIX,
    /**
