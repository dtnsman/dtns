...
class DNALinkRPC
{
    ...
    async token_op_block(req,res)
    {
        ...
        {
            //http://127.0.0.1:60000/op?appid=10001&secret_key=&token_x=valuetest_file22aunvJuZg83&token_y=valuetest_file22aunvJuZg83&opcode=file.download&opval=1659583973
            req.params = !req.params ? {}:req.params
            req.params.token = token_y
            req.params.next = true;
        ...
        }else if(opcode.indexOf(this.fsm_config.OP_WEBSOCKET)==0)
        {
            ...
            {
                //http://127.0.0.1:60000/op?access_key=&appid=10001&secret_ke1y=&acss_key=&token_x=valuetest_2wihzNDAb2Aa8arW&token_y=valuetest_2wihzNDAb2Aa8arW&begin=0&len=1000000000&&web3_sign1=1&opcode=websocket.token.write&extra_data=wslisten-helloworld&opval=http://127.0.0.1:611111
        ...
        {
            //http://127.0.0.1:60000/op?appid=10001&secret_key=&token_x=valuetest_0000000000000000&token_y=valuetest_0000000000000000&opcode=access.chain&opval=50000&extra_data=wslisten-helloworld
            if(opcode == this.fsm_config.OP_ACCESS_BAN)
            {
                ...
                if(opcode==this.fsm_config.OP_ACCESS_CHAIN_OPEN)
                {
                    ...
                    //http://127.0.0.1:60000/op?token_key1=&appid=10001&secret_key=&acss_key=&token_x=valuetest_2wihzNDAb2Aa8arW&token=valuetest_2wihzNDAb2Aa8arW&token_y=valuetest_0000000000000000&begin=0&len=1000000000&&web3_sign1=1&opcode=access.chain.open&extra_data=&opval=access.chain.open
        ...
        {
            //http://127.0.0.1:60000/op?token_key=&appid=10001&secret_key=&token_x=valuetest_0000000000000000&acss_key=accf8ea53fa1964bb8aa810b045ed13a85277ae8ff9520d2b132ea4a181e50419d4&token_y=valuetest_0000000000000000&opcode=access.all&opval=50&extra_data=wslisten-helloworld
        ...
        {
            //http://127.0.0.1:60000/op?token_key=&appid=&secret_key=&acss_key=&token_x=valuetest_24hs9nV2XajdEc7F&token_y=valuetest_24hs9nV2XajdEc7F&begin=0&len=1000000000&opcode=web3.token.open&opval=web3.token.open&extra_data=wslisten-helloworld
            //do nothing
        ...
        //http://ec2-52-81-96-59.cn-north-1.compute.amazonaws.com.cn:61000/node.lauo.valuetest/op?appid=10001&secret_key=&token_x=valuetest_file272eH1bg8Rtj&token_y=valuetest_file272eH1bg8Rtj&opcode=web3.meta.set&opval=%7B%22file_id%22%3A%20%22valuetest_file272eH1bg8Rtj%22%2C%22methods%22%3A%20%7B%22screenshot%22%3A%20%22screenshot%22%2C%22setProfile%22%3A%22setProfile%22%7D%2C%22width%22%3A%20480%2C%22height%22%3A%20960%7D&extra_data=web3.meta.set-helloworld&begin=0&len=100
        //http://ec2-52-81-96-59.cn-north-1.compute.amazonaws.com.cn:61000/node.lauo.valuetest/op?appid=10001&secret_key=&token_x=valuetest_file272eH1bg8Rtj&token_y=valuetest_file272eH1bg8Rtj&opcode=web3.meta.call&opval=%7B%22method%22%3A%22setProfile%22%2C%22params%22%3A%7B%22name%22%3A%22%E5%BC%A0%E5%B0%91%E6%A5%9A%22%2C%22date%22%3A%222022%2F08%2F12%22%7D%7D&extra_data=wslisten-helloworld
        //http://ec2-52-81-96-59.cn-north-1.compute.amazonaws.com.cn:61000/node.lauo.valuetest/op?appid=10001&secret_key=&token_x=valuetest_file272eH1bg8Rtj&token_y=valuetest_file272eH1bg8Rtj&opcode=web3.meta.call&opval=%7B%22method%22%3A%22screenshot%22%2C%22params%22%3A%7B%22name%22%3A%22%E5%BC%A0%E5%B0%91%E6%A5%9A%22%2C%22date%22%3A%222022%2F08%2F12%22%7D%7D&extra_data=wslisten-helloworld
    ...
    */
     ...
     *
     * 加上了密钥信息，否则无法访问。
     * http://127.0.0.1:88/chain/query_token_chain_bytoken_opcode?token=token_0000000000000000&begin=0&len=10&opcode=fork&appid=1001&secret_key=
     *
     */
     ...
     * http://127.0.0.1:59868/chain/map/values?appid=10001&secret_key=&opcode=map&token=tns_0000000000000000&begin=0&len=100
     */
     ...
     * http://127.0.0.1:59868/chain/map/keys?appid=10001&secret_key=&opcode=map&token=tns_0000000000000000&begin=0&len=100
     */
    ...
    async common_interceptor(req, res, next) {
        ...
        {
            //http://127.0.0.1:60000/fork?token_key1=tkacc2dd1b994ef98e133bd547927824c4168e82c880a799ff2f41271cda5c321f5ab&appid=&secret_key=&acss_key=&token=valuetest_24hs9nV2XajdEc7F&token_y=valuetest_0000000&begin=0&len=1000000000&opcode=fork&opval=web3.token.open&extra_data=wslisten-helloworld
