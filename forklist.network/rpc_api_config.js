...
module.exports={
    ...
    // MSGA_API_BASE: 'https://c6.forklist.dtns/node.'+'FourteenYuan'+'.'+MSGA_TOKEN_NAME,
    // MSGA_TOKEN_NAME: MSGA_TOKEN_NAME,
    // MSGA_TOKEN_ROOT:MSGA_TOKEN_NAME+"_0000000000000000",

    // //#1 用户模块-user
    // RPC_API_BASE:'forklist.dtns',
    // USER_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+USER_TOKEN_NAME,
    // USER_TOKEN_NAME: USER_TOKEN_NAME,
    // USER_TOKEN_ROOT:USER_TOKEN_NAME+"_0000000000000000",
    // //#2 人民币模块-rmb
    // RMB_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+RMB_TOKEN_NAME,
    // RMB_TOKEN_NAME: RMB_TOKEN_NAME,
    // RMB_TOKEN_ROOT:RMB_TOKEN_NAME+"_0000000000000000",

    // //#3 共识币模块-gsb
    // GSB_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+GSB_TOKEN_NAME,
    // GSB_TOKEN_NAME: GSB_TOKEN_NAME,
    // GSB_TOKEN_ROOT:GSB_TOKEN_NAME+"_0000000000000000",

    // //#4 经验值模块-score
    // SCORE_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+SCORE_TOKEN_NAME,
    // SCORE_TOKEN_NAME: SCORE_TOKEN_NAME,
    // SCORE_TOKEN_ROOT:SCORE_TOKEN_NAME+"_0000000000000000",

    // //#5 代金券模块-pcash
    // PCASH_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+PCASH_TOKEN_NAME,
    // PCASH_TOKEN_NAME: PCASH_TOKEN_NAME,
    // PCASH_TOKEN_ROOT:PCASH_TOKEN_NAME+"_0000000000000000",

    // //#6 VIP模块-vip
    // VIP_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+VIP_TOKEN_NAME,
    // VIP_TOKEN_NAME: VIP_TOKEN_NAME,
    // VIP_TOKEN_ROOT:VIP_TOKEN_NAME+"_0000000000000000",

    // //#7 订单模块-order
    // ORDER_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+ORDER_TOKEN_NAME,
    // ORDER_TOKEN_NAME: ORDER_TOKEN_NAME,
    // ORDER_TOKEN_ROOT:ORDER_TOKEN_NAME+"_0000000000000000",

    // //#8 消息模块-msg
    // MSG_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+MSG_TOKEN_NAME,
    // MSG_TOKEN_NAME: MSG_TOKEN_NAME,
    // MSG_TOKEN_ROOT:MSG_TOKEN_NAME+"_0000000000000000",

    // //#9 内容和商品-事物模块-obj
    // OBJ_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+OBJ_TOKEN_NAME,
    // OBJ_TOKEN_NAME: OBJ_TOKEN_NAME,
    // OBJ_TOKEN_ROOT:OBJ_TOKEN_NAME+"_0000000000000000",

    // //#10 合约/合同模块-ht
    // HT_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+HT_TOKEN_NAME,
    // HT_TOKEN_NAME: HT_TOKEN_NAME,
    // HT_TOKEN_ROOT:HT_TOKEN_NAME+"_0000000000000000",

    // SMS_API_BASE: 'https://c0.forklist.dtns/node.'+NODEID+'.'+SMS_TOKEN_NAME,
    // SMS_TOKEN_NAME: SMS_TOKEN_NAME,
    // SMS_TOKEN_ROOT:SMS_TOKEN_NAME+"_0000000000000000",
};
 ...
 * @type {rpc_query}
 */
module.exports.rpc_query = rpc_query
async function rpc_query(url,reqdata){
    ...
    // if(url.indexOf('node.'+NODEID+'.user')>0)
    // {
    //     reqdata.appid = '10001'
    //     reqdata.secret_key = '*'
    // }

    if(url.indexOf('127.0.0.1:50990')>0)
    {
        reqdata.appid = '10001'
        reqdata.secret_key = '*'
    }

    if(url.indexOf('127.0.0.1:50991')>0)
    {
        reqdata.appid = '10001'
        reqdata.secret_key = '*'
    }

    if(url.indexOf('127.0.0.1:50992')>0)
    {
        reqdata.appid = '10001'
        reqdata.secret_key = '*'
    }

    if(url.indexOf('127.0.0.1:50993')>0)
    {
        reqdata.appid = '10001'
        reqdata.secret_key = '*'
    }
