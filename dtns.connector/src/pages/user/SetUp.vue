...
<template>
    ...
    <div class="setting">
        ...
        <div style="position:relative; width:100%;">
            ...
            <van-cell to="/checking" title="找回密码" is-link style="padding-left:43px;" />
            ...
            <van-cell @click="ChatSingle" title="联系客服" style="padding-left:43px;" is-link />
            ...
            <van-cell to="/user/AboutSoftwar" title="关于软件" style="padding-left:43px;" is-link />
            ...
            <van-cell to="/user/ErrorLog" title="查看日志" style="padding-left:43px;" is-link />
            ...
            <van-cell title="切换节点" style="padding-left:43px;" is-link to="/changeSvrNode" />
        </div>
        <!-- <van-divider />
    ...
    export default {
        ...
        methods:{
            ...
            async changeMode(){
                ...
                this.darkModeText = dark_mode ? '极黑模式（当前）':'正常模式（当前）'
                if(dark_mode){
