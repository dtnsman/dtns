...
// app.use(express.static('layui-pro/start'))
...
async function loginDtnsAndForklist()
{
    ...
    if(ll_config.defaultRTCRoomID=='nftlist')
        return ;
...
{
    //config.js
    ll_config.roomid = window.g_dev_origin_roomid ? window.g_dev_origin_roomid : roomid
    ll_config.defaultRTCRoomID = window.g_dev_origin_roomid ? window.g_dev_origin_roomid : defaultRTCRoomID
    roomid = defaultRTCRoomID = ll_config.roomid
    configLDB()
    //lx_all.js
