...
const ll_config = {
    ...
    chat_share_url : 'http://lianxian.opencom.cn/#/LiveBroadcast/videoChat/',
    live_ffmpeg_bin:'/data/ffmpeg-4.2.2-i686-static/ffmpeg',
    //客服系统
    init_console_user:'user_EVHz9jWgguskivVZ',
    //port: 80,
    name: 'linkline.cn',
    redis_key:'linkline_key:',
    deploy_interval_time:10000,
    version:100,// pkg.version,
    file_temp:__dirname+'/file_temp/',
    log_path:__dirname+"/logs/",
    //2023-1-6
    roomid:'linkline-svr-cell',
    defaultRTCRoomID:'linkline-cell',
...
window.dtns_root_keys = {private_key:'HqDnKJQJMRNMGNxX7opwPmAFbUjPhH88dHRCcTRWeL9S',
            public_key:'wYMbBx7uLxrq5oRPsKbmc5eSnuhNt5iW5uBu5QSJhSzo',
            token:'dtns_svr000app2QChoYph6z3yN4e2k5D66md'}

// window.g_allow_users = 'user_EVHz9jWgguskivVZ'
window.g_file_download_not_need_session_flag = true
...
window.g_dev_roomid='dev00*'
window.g_dev_origin_roomid='svr'
