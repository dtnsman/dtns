...
const MARK_TOKEN_NAMESPACE_PRE_FIX="marknetwork_"
const MARK_TOKEN_NAMESPACE='mark'

window.mark_config= {}
window.mark_config.fsm_config = {
...
window.mark_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:MARK_TOKEN_NAMESPACE+'_000000000000000000000000000000',
        /**
     ...
     */
    TOKEN_NAME:MARK_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:MARK_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:MARK_TOKEN_NAMESPACE_PRE_FIX,
    /**
