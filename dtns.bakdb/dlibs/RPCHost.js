...
async function queryTurnPwd()
{
    if(ll_config.roomid=='dtns')
    {
        ...
        window.g_turn_pwd = await
            http_req.http_post(get_RTCHOST_TNS_SERVER_URL()+'/c',//?timestamp='+time_x+'&sign='+encodeURIComponent(time_sign_base64), 
            {
                timestamp:time_x ,
...
class RTCHost
{
    ...
    async initSvr()
    {
        ...
        //先获得turn-pwd
        let turnPWD = await queryTurnPwd()
