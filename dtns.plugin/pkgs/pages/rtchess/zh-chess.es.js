...
var ZhChess = /** @class */ (function () {
    ...
    Object.defineProperty(ZhChess.prototype, "update", {
        ...
        value: function (pos, mov, side, post) {
            ...
            var moveCheck = function (cp) {
                ...
                if (enemyhasTrouble) {
                    _this.logEvents.forEach(function (f) { return f(side + "方： 将军"); });
            ...
            if (!moveFlag.flag) {
                ...
                var cp = { eat: mov };
                var moveResult = moveCheck(cp);
                if (moveResult) {
                    this.logEvents.forEach(function (f) { return f(_this.currentSide + '吃了' + movPeice); });
                }
                return moveResult;
            }
        }
    ...
    */
     ...
     *
     */
    Object.defineProperty(ZhChess.prototype, "getCurrentSideVal", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
     ...
     * 得到choosePiece
     */
    Object.defineProperty(ZhChess.prototype, "getChoosePieceVal", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function () {
