...
// generate message to sign
    let msg = Buffer.from("wellcom to beijing--from poplang", "utf8")
    ...
    var text = Buffer.from("wellcom to beijing--from poplang北京欢迎你，哈哈，是吗，这确实不错呢，你非常可以呢？3123423哈哈，翰的不错《}{}你是来自哪里呢，非常可以啊,11", "utf8")
